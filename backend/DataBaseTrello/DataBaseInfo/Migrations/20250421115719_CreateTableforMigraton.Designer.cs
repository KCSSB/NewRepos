...
namespace DataBaseInfo.Migrations
{
    ...
    [Migration("20250421115719_CreateTableforMigraton")]
    partial class CreateTableforMigraton
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataBaseInfo.models.Password", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DataBaseInfo.models.Password", b =>
                {
                    b.HasOne("DataBaseInfo.models.User", "User")
                        ...
                        .HasForeignKey("DataBaseInfo.models.Password", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
